...
<h4>Mobile  and Apps</h4>
  <Link className={style.link} to="https://www.facebook.com/"><AiOutlineGlobal/><span className={style.name} >FoodGalery.com</span> </Link>
...
<span  className={style.name} >FoodGalery Tv Ads</span>
</div> 
